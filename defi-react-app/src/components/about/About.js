        ...
        <div>
            <div className="about">
                <div className="container">
                    ...
                    <p>The Defi protocol system empowers developers, liquidity providers, and traders to particiapte in a financial marketplace that is open and accessible to all.</p>
